...
time.sleep(4)
country = browser.find_element_by_xpath('//*[@id="detail_0_home_navy"]/div[1]/div/div[69]')
country.click()
time.sleep(2)
...
region.click()
time.sleep(2)
team = browser.find_element_by_xpath('//*[@id="detail_0_competition_navy_0"]/div[1]/div/div[9]/div/div[1]/img')
team.click()
time.sleep(2)
...
while game_counter <= 100:
    ...
    while scheme_counter <= 12:
        ...
        pd.DataFrame(data_table).to_csv(r'/home/gleb/Desktop/data_FNL/Luch/general/df_[%s][%s]%s.csv' % (game_name_1, game_name_2, scheme_counter-9))
        browser.implicitly_wait(10)
        browser.execute_script("arguments[0].click();", scheme)
        scheme_counter += 1
